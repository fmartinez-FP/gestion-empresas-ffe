            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between gap-4">
                    ...
                    <nav class="hidden md:flex items-center gap-1">
                        ...
                        <a href="{{ route('alumnos.index') }}" class="nav-link px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-2 {{ request()->routeIs('alumnos.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700' }}">
                        ...
                        @admin
                        <a href="{{ route('admin.curriculum.index') }}" class="nav-link px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-2 {{ request()->routeIs('admin.curriculum.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-400' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700' }}">
