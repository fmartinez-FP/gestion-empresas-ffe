    ...
    <form method="POST" action="{{ route('alumnos.update', $alumno) }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre', $alumno->nombre) }}"
                       @required(auth()->user()->can('editarIdentidadAlumno', App\Models\Alumno::class))
                       @disabled(! auth()->user()->can('editarIdentidadAlumno', App\Models\Alumno::class))
                       class="w-full rounded-lg border @error('nombre') border-red-400 @else border-gray-300 @enderror px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed">
            ...
            <div>
                ...
                <input type="text" name="apellidos" value="{{ old('apellidos', $alumno->apellidos) }}"
                       @required(auth()->user()->can('editarIdentidadAlumno', App\Models\Alumno::class))
                       @disabled(! auth()->user()->can('editarIdentidadAlumno', App\Models\Alumno::class))
                       class="w-full rounded-lg border @error('apellidos') border-red-400 @else border-gray-300 @enderror px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                @else
                    ...
                    <select id="filtro-ciclo"
                            @disabled(! auth()->user()->can('editarGrupoAlumno', App\Models\Alumno::class))
                            class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed">
            ...
            <div>
                ...
                <select name="grupo_id" id="select-grupo"
                        @required(auth()->user()->can('editarGrupoAlumno', App\Models\Alumno::class))
                        @disabled(! auth()->user()->can('editarGrupoAlumno', App\Models\Alumno::class))
                        class="w-full rounded-lg border @error('grupo_id') border-red-400 @else border-gray-300 @enderror px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed">
        ...
        <div>
            ...
            <input type="text" name="curso_academico" value="{{ old('curso_academico', $alumno->curso_academico) }}"
                   ...
                   @required(auth()->user()->can('editarGrupoAlumno', App\Models\Alumno::class))
                   @disabled(! auth()->user()->can('editarGrupoAlumno', App\Models\Alumno::class))
                   class="w-full sm:w-1/2 rounded-lg border @error('curso_academico') border-red-400 @else border-gray-300 @enderror px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed">
