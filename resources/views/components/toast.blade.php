...
<div 
    ...
    {{ $attributes->merge(['class' => "flex items-center gap-3 p-4 rounded-xl border {$config['bg']} {$config['border']} {$config['text']} shadow-lg"]) }}
>
    ...
    <button @click="show = false" class="flex-shrink-0 p-1 hover:bg-white/50 rounded-lg transition-colors">
