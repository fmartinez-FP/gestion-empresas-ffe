...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form method="POST" action="{{ route('asignaciones.store', $alumno) }}"
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-5">
            ...
            <p class="text-xs text-gray-400 mb-4">Por defecto solo de lunes a viernes. El número de horas totales se calcula automáticamente a partir de las fechas de inicio/fin y el calendario de la asignación.</p>
    ...
    return {
        ...
        toggleViernes() {
            if (this.bloqueViernes.jornadaPartida) {
                // No hay preset definido para el reparto partido del viernes — relleno manual
        ...
        // Réplica de HorarioAsignacionService::validarHorarios() — errores duros, bloquean envío.
        erroresDia(d) {
            const errores = [];
        ...
        // Réplica de HorarioAsignacionService::advertencias() — avisos suaves, no bloquean.
        advertencias() {
            const avisos = [];
